...
        
            \[UIView animateWithDuration:DELAY\_TIME animations:^{
]()            
...
                /\**                  *  发起网络请求,请求刷新数据
                 \*/
                dispatch\_after(dispatch\_time(DISPATCH\_TIME\_NOW, (int64\_t)(DELAY\_TIME \* NSEC\_PER\_SEC)), dispatch\_get\_main\_queue(), ^{
                    NSLog(@"下拉刷新结束了");
                    \[UIView animateWithDuration:DELAY\_TIME animations:^{
]()                    
...
        
            NSLog(@"%d %s",\_\_LINE__,\_\_FUNCTION__);
